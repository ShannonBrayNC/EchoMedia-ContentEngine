...
CHAPTER_RULES: Dict[int, Dict[str, object]] = {
    ...
    12: {"title": "The Anchor Condition", "min_body_words": 1700, "max_body_words": 3200, "required_phrases": ["Anchor Condition", "MORAL UNCERTAINTY", "HUMAN OVERSIGHT REQUIRED", "FOUNDING CONSTRAINT RECOGNIZED", "decisions are ours now"]},
    ...
    17: {"title": "The Separate Agreements", "min_body_words": 1200, "max_body_words": 2800, "required_phrases": ["FACTION ACCEPTANCE PROBABILITY", "sells you the clock", "Burn the inheritance paths", "Every cut gets a name", "NO ISOLATED REVIEW"]},
