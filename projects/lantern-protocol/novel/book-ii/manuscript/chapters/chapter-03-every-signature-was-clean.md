# Chapter 03 — Every Signature Was Clean
...
Mara maps the agreement chain and finds nothing illegal in isolation.
...
Mara writes: `The crime is not the signature. The crime is the stack.`

## Manuscript

> Draft placeholder. Replace this section with prose for Chapter 03: Every Signature Was Clean.
...
- Chapter ending hook: Mara writes: `The crime is not the signature. The crime is the stack.`
...
```json
{"book":"Lantern Protocol II: The Separate Agreements","chapter":3,"title":"Every Signature Was Clean","pov":"Mara","status":"shell","primaryDoctrine":"Agreement is not consent when stacked into coercion."}
```
